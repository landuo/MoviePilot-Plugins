...
import { _ as _export_sfc, f as formatBytes, t as taskStateMeta, u as unwrapResponse } from './_plugin-vue_export-helper-CSZflgAN.js';
...
async function loadStatus() {
  ...
  loading.value = true;
  try {
    status.value = unwrapResponse(await props.api.get('plugin/BrushFlowLanduo/status')) || status.value;
  } finally {
    loading.value = false;
  }
}
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-b789f98b"]]);
